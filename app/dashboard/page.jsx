...
export default function Dashboard() {
  ...
  return (
    <div style={{ padding: 18 }}>
      ...
      <div style={{ color: '#374151' }}>This is a simplified dashboard while we fix the client crash.</div>
      ...
      <div style={{ marginTop: 14 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={() => router.push('/join?mode=one-on-one&exam=jee&subject=physics')} className="btn">Join 1-on-1 (Physics)</button>
