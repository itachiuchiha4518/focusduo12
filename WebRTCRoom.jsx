    ...
    <div style={{
      ...
      <div style={{ maxWidth: 400, width: '100%', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          ✅ You can leave now — free, no credit used
        </div>

        <div style={{ marginBottom: 16, textAlign: 'left' }}>
          <div style={{ color: '#94a3b8', fontSize: 13, marginBottom: 6, fontWeight: 600 }}>
            Subject: <strong style={{ color: '#e2e8f0' }}>{session?.exam} • {session?.subject}</strong>
          </div>
          <input
            value={chapter}
      ...
      {rating > 0 && (
        <div style={{ marginBottom: 14 }}>
          <div style={{ color: '#94a3b8', fontSize: 13, marginBottom: 6 }}>
            {rating >= 4 ? '😊 What did they do well?' : '🤔 What could be better?'} (optional)
          </div>
          <input
            value={comment}
...
export default function WebRTCRoom({ sessionId, session: sessionProp }) {
  ...
  // ── Hide controls after 4s inactivity ──
    ...
    >
      ...
      {showNudge && !nudgeDismissed && isFree && (
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 900, color: '#fca5a5', fontSize: 14 }}>⏰ 5 minutes left!</div>
            <div style={{ color: '#cbd5e1', fontSize: 12, marginTop: 2 }}>Upgrade for ₹99 and never get cut off again.</div>
          </div>
      ...
      <div style={{
        ...
        {/* Remote video — main, fills container */}
        <video
          ref={remoteVideoRef}
        ...
        {/* ── CHAPTER SELECTION SCREEN (grace period) ── */}
      ...
      <div style={{ marginTop: 10, display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        {isFree && inGrace && (
          <div style={{
            ...
            ✅ Grace period — leave now, no credit used ({formatTime(setupLeft)})
          </div>
        )}
        {!isFree && (
          <div style={{
            ...
            ⭐ Unlimited session — no time limit
          </div>
        )}
      </div>
